...
<div className="subheading min-letter-space" id='validate'>
    Validação de erros a nível de campo.
</div>
<p>
    Nesse exemplo, observa-se algumas validações a nível de campo.

    In addition to the ways to handle errors shown below, you can use the
    [resolvers of react-hook-form](https://github.com/react-hook-form/resolvers#quickstart)
</p>
...
<div className="subheading min-letter-space">
    Validação de erros assíncronos a nível de campo.
</div>
<div className='canvas-code'>
    <div className='wrap-code left'>
